...
#define ORDER_STRING_SIZE 5

#define STATE_STRING_SIZE 5

#define BACKUP_STRING_SIZE 50

#define N_Q (N_FLOORS * 3)
...
//Hvordan skal en struct for bestillinger se ut?
typedef struct order {
	int floor, dir, elevNr;
}order;
...
int internalOrdersQ[4];

int elevatorStates[N_ELEVATORS];

int elevatorPositions[N_ELEVATORS];
